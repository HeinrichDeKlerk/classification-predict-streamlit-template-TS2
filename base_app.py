...
with open("resources/vectorizers/vectorizers.pkl", "rb") as file:
    vect_list = pickle.load(file)
...
def main():
        ...
        # Remove blanks
                ...
                choice = st.selectbox("Please choose a Classification Model",list(models_dict.keys()))
